...
- `REDIS_URL`: URL di connessione al database Redis (es. Upstash, Redis Cloud). Viene utilizzato sia per lo storage dello stato, sia per la pubblicazione/sottoscrizione degli eventi realtime tramite l'endpoint SSE.
